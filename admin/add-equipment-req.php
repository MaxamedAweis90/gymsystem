...
if(!$result){
    $_SESSION['error_message'] = "Error occured while entering details.";
    header("Location: equipment-entry.php");
    exit();
} else {
    $_SESSION['success_message'] = "Equipment record has been added successfully!";
